DROP TABLE IF EXISTS init_latest_player_score;
CREATE TABLE init_latest_player_score (
...
INSERT INTO init_latest_player_score SELECT t1.tenant_id, t1.competition_id, t1.player_id, t1.score, t1.created_at, t1.updated_at FROM player_score t1 JOIN (
